...
public:
    ...
    static bool isPure(std::string_view name) noexcept {
...
private:
    ...
    /// Using string_view keys allows O(1) lookup from any std::string_view in C++17.
    static const std::unordered_map<std::string_view, BuiltinEffects>& table() noexcept;
};
