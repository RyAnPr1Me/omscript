...
void printUsage(const char* progName) {
    std::cout << kCompilerVersion
              ...
              << " [command] [<file.om>] [options]\n"
                 ...
                 "  build, compile, --build, --compile   Compile to executable (default)\n"
                 "  run, --run                           Compile and run\n"
                 "  check, --check                       Validate syntax and types\n"
                 "  emit-ir, --emit-ir                   Print LLVM IR\n"
                 "  lex, --lex, --dump-tokens            Print tokens\n"
                 "  parse, --parse, --emit-ast           Print AST\n"
