...
const std::unordered_map<std::string_view, BuiltinEffects>& BuiltinEffectTable::table() noexcept {
    ...
    static const std::unordered_map<std::string_view, BuiltinEffects> kTable = {
        ...
        {"str_upper",       {true,  true,  false, false, false, false, true,  false}},
        {"str_lower",       {true,  true,  false, false, false, false, true,  false}},
        {"str_trim",        {true,  true,  false, false, false, false, true,  false}},
        {"str_reverse",     {true,  true,  false, false, false, false, true,  false}},
        {"str_substr",      {true,  true,  false, false, false, false, true,  false}},
        {"str_replace",     {true,  true,  false, false, false, false, true,  false}},
        {"str_repeat",      {true,  true,  false, false, false, false, true,  false}},
        {"str_pad_left",    {true,  true,  false, false, false, false, true,  false}},
        {"str_pad_right",   {true,  true,  false, false, false, false, true,  false}},
        {"str_concat",      {true,  true,  false, false, false, false, true,  false}},
        {"str_chars",       {true,  true,  false, false, false, false, true,  false}},
        {"str_join",        {true,  true,  false, false, false, false, true,  false}},
        {"str_split",       {true,  true,  false, false, false, false, true,  false}},
        ...
        {"array_fill",      {true,  false, false, false, false, false, true,  false}},
        {"array_concat",    {true,  true,  false, false, false, false, true,  false}},
        {"array_slice",     {true,  true,  false, false, false, false, true,  false}},
        {"array_copy",      {true,  true,  false, false, false, false, true,  false}},
        {"range",           {true,  false, false, false, false, false, true,  false}},
        {"range_step",      {true,  false, false, false, false, false, true,  false}},

        // ── Map reads (read-only, NOT const-foldable at compile time) ─────
        {"map_get",         {false, true,  false, false}},
        {"map_has",         {false, true,  false, false}},
        {"map_keys",        {false, true,  false, false, false, false, true,  false}},
        {"map_values",      {false, true,  false, false, false, false, true,  false}},
        ...
        // ── I/O builtins ──────────────────────────────────────────────────
        //                                CF     RM     WM     IO     Throw  NoRet  Alloc  Dealloc
        ...
        {"file_read",       {false, false, false, true,  true,  false, true,  false}},
        {"file_write",      {false, false, false, true,  true,  false, false, false}},
        {"file_append",     {false, false, false, true,  true,  false, false, false}},
        {"file_exists",     {false, false, false, true,  false, false, false, false}},
        {"fopen",           {false, false, false, true,  true,  false, true,  false}},
        {"fclose",          {false, false, false, true,  false, false, false, true }},
        {"fread",           {false, false, false, true,  true,  false, false, false}},
        {"fwrite",          {false, false, false, true,  true,  false, false, false}},
        {"fappend",         {false, false, false, true,  true,  false, false, false}},
        {"thread_create",   {false, false, false, true,  true,  false, true,  false}},
        {"thread_join",     {false, false, false, true,  true,  false, false, false}},
        {"thread_detach",   {false, false, false, true,  true,  false, false, false}},
        {"mutex_lock",      {false, false, false, true,  false, false, false, false}},
        {"mutex_try_lock",  {false, false, false, true,  false, false, false, false}},
        {"mutex_unlock",    {false, false, false, true,  false, false, false, false}},
        {"mutex_new",       {false, false, false, true,  false, false, true,  false}},
        {"mutex_destroy",   {false, false, false, true,  false, false, false, true }},
        {"sleep",           {false, false, false, true}},
        {"exit",            {false, false, false, true,  false, true,  false, false}},
        {"exit_program",    {false, false, false, true,  false, true,  false, false}},
        {"abort",           {false, false, false, true,  false, true,  false, false}},
        {"panic",           {false, false, false, true,  true,  true,  false, false}},
        {"error",           {false, false, false, true,  true,  false, false, false}},
        {"assert",          {false, false, false, true,  true,  false, false, false}},
        // ── Region management builtins ────────────────────────────────────────
        {"newRegion",       {false, false, true,  false, false, false, true,  false}},
        {"alloc",           {false, false, true,  false, false, false, true,  false}},
